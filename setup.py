...
EXTRAS["mujoco"] = [
    # "-e git+https://github.com/Farama-Foundation/d4rl.git@305676ebb2e26582d50c6518c8df39fd52dea587#egg=D4RL"
    # "mujoco==2.2.2",
    # "mujoco-py==2.1.2.14",
    # "mujoco==2.2.2",
    # "mujoco-py==2.1.2.14",
    ...
    # f"gym==0.21.0",
    # f"gym==0.22.0",
    # f"gym==0.21.0 @ git+https://github.com/qgallouedec/gym-continuous-maze.git@8292fadb2ec1578948d9ce1a64c9e0b273de68d6#egg=gym_continuous_maze",
    # f"gym[all]==0.21.0",
